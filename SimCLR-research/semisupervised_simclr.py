...
baseline_history = baseline_model.fit(
    ...
    callbacks=[ModelCheckpoint(filepath="./baseline_model", save_best_only=True)],
)
...
pretraining_history = pretraining_model.fit(
    ...
    epochs=num_epochs,
    validation_data=test_dataset,
    callbacks=[ModelCheckpoint(filepath="./pretraining_model", save_best_only=True)],
)
print(
    "Maximal validation accuracy: {:.2f}%".format(
...
finetuning_history = finetuning_model.fit(
    ...
    epochs=num_epochs,
    validation_data=test_dataset,
    callbacks=[ModelCheckpoint(filepath="./finetuning_model", save_best_only=True)],
)
print(
    "Maximal validation accuracy: {:.2f}%".format(
